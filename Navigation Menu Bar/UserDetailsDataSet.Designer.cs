...
namespace Navigation_Menu_Bar {
    ...
    public partial class UserDetailsDataSet : global::System.Data.DataSet {
        ...
        public partial class RegistrationDataTable : global::System.Data.TypedTableBase<RegistrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public RegistrationRow AddRegistrationRow(string FirstName, string LastName, string Email, string Password, string Address) {
...
namespace Navigation_Menu_Bar.UserDetailsDataSetTableAdapters {
    ...
    public partial class RegistrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Registration] WHERE (([Id] = @Original_Id) AND ([FirstName] = " +
                "@Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Email] = @Origi" +
                "nal_Email) AND ([Password] = @Original_Password) AND ([Address] = @Original_Addr" +
                "ess))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Registration] ([FirstName], [LastName], [Email], [Password], [Address]) VALUES (@FirstName, @LastName, @Email, @Password, @Address);
SELECT Id, FirstName, LastName, Email, Password, Address FROM Registration WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Registration] SET [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email, [Password] = @Password, [Address] = @Address WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Address] = @Original_Address));
SELECT Id, FirstName, LastName, Email, Password, Address FROM Registration WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Navigation_Menu_Bar.Properties.Settings.Default.UserDetailsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Email, Password, Address FROM dbo.Registration";
        ...
        public virtual int Fill(UserDetailsDataSet.RegistrationDataTable dataTable) {
        ...
        public virtual UserDetailsDataSet.RegistrationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDetailsDataSet.RegistrationDataTable dataTable = new UserDetailsDataSet.RegistrationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDetailsDataSet.RegistrationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, string Original_Address) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Email, string Password, string Address) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Email, string Password, string Address, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, string Original_Address, int Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string Password, string Address, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Password, string Original_Address) {
            return this.Update(FirstName, LastName, Email, Password, Address, Original_Id, Original_FirstName, Original_LastName, Original_Email, Original_Password, Original_Address, Original_Id);
        }
    }
