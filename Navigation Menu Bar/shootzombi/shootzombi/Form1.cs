...
namespace shootzombi
{
    public partial class Form1 : Form
    {
        ...
        private void KeyIsUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space && ammo > 0 && gameOver==false) // in this if statement we are checking if the space bar is up and ammo is more than 0
            {
        ...
        private void DropAmmo()
        {
            ...
            ammo.Left = rnd.Next(10, this.ClientSize.Width -ammo.Width); // set the location to a random left
            ammo.Top = rnd.Next(60, this.ClientSize.Height - ammo.Height); // set the location to a random top
